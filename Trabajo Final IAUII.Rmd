...
*Conclusiones del gráfico: A partir de la entrada en vigencia de la norma, se vislumbra cierta disminución del share que representan los alquileres sobre el total de las unidades ofertadas. Esta caida se vuelve algo mas evidente en los últimos meses analizados. Sin embargo, en los meses muestreados no puede concluirse de forma terminante que la cantidad de alquileres haya diminuido sobre el total, mas bien parece acompañar la tendencia general*
